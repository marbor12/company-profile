 ...
 * File ini berisi konfigurasi koneksi database untuk sistem admin idSpora
 */
...
// Optional: Auto-test connection when file is included
if (basename($_SERVER['PHP_SELF']) === 'database.php') {
    if (testConnection()) {
        ...
        echo "<br><br>Database Statistics:";
        echo "<br>Total Events: " . $stats['total_events'];
        echo "<br>Total Mentors: " . $stats['total_mentors'];
        echo "<br>Total News: " . $stats['total_news'];
        echo "<br>Total Reviews: " . $stats['total_reviews'];
        
        // Show available tables
        echo "<br><br>Available Tables:";
