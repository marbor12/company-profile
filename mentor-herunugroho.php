...
<head>
    ...
    <title>Dr. Heru Nugroho - Mentor Profile | idSpora</title>
    ...
    <style>
        ...
        .experience-table::-webkit-scrollbar-track {
            background: #f1f1f1;
            border-radius: 10px;
        }

        .experience-table::-webkit-scrollbar-thumb {
            background: var(--primary-yellow);
            border-radius: 10px;
        }

        .experience-table::-webkit-scrollbar-thumb:hover {
            background: #d4ac26;
        }
        ...
        .experience-table .year {
            font-weight: 600;
            color: var(--dark-blue);
            text-align: center;
        }

        .experience-table .duration {
            text-align: center;
            font-weight: 500;
        }
        ...
        <nav aria-label="breadcrumb">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Dr. Heru Nugroho</li>
                </ol>
            </div>
        </nav>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-center" data-aos="fade-right">
                        <img src="property/heru.png" alt="Dr. Heru Nugroho"
                            class="mentor-photo" />
                        <div class="social-links-large">
                            <a href="https://www.linkedin.com/in/heru-nugroho" target="_blank">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <a href="mailto:heru.nugroho@idSpora.com">
                                <i class="fas fa-envelope"></i>
                            </a>
                            <a href="property/cv_paheru.pdf" target="_blank">
                                <i class="fas fa-file-alt"></i>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-8" data-aos="fade-left">
                        <h1 class="mentor-name">Dr. Heru Nugroho, S.Si., M.T</h1>
                        <p class="mentor-title">IT Governance Expert & SPBE Specialist</p>
                        <p class="mentor-description">
                            Seorang pakar di bidang tata kelola teknologi informasi dan
                            Sistem Pemerintahan Berbasis Elektronik (SPBE) dengan pengalaman
                            11 tahun. Memiliki latar belakang pendidikan S1 Matematika, S2
                            Informatika (Sistem Informasi), dan S3 Teknik Elektro &
                            Informatika dari ITB. Berpengalaman dalam menyusun arsitektur
                            enterprise, kebijakan tata kelola TI, dan evaluasi sistem
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                                <div class="skill-item d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-2">IT Governance & Policy</h5>
                                        <p class="text-muted mb-0">
                                            Penyusunan kebijakan tata kelola TI dan framework
                                            governance untuk enterprise.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 mb-4" data-aos="fade-up" data-aos-delay="200">
                                <div class="skill-item d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-2">Enterprise Architecture</h5>
                                        <p class="text-muted mb-0">
                                            Perancangan arsitektur enterprise dan pemetaan sistem
                            ...
                            <div class="col-lg-6 mb-4" data-aos="fade-up" data-aos-delay="300">
                                <div class="skill-item d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-2">SPBE Assessment & Planning</h5>
                                        <p class="text-muted mb-0">
                                            Evaluasi dan penyusunan rencana induk Sistem
                            ...
                            <div class="col-lg-6 mb-4" data-aos="fade-up" data-aos-delay="400">
                                <div class="skill-item d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-2">Data Mining & Visualization</h5>
                                        <p class="text-muted mb-0">
                                            Analisis data mining dan visualisasi data untuk
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <div class="social-links">
                            <a href="https://www.tiktok.com/@idspora" class="text-light me-3"><i
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <div class="social-links">
                            <a href="https://www.tiktok.com/@idspora" class="text-light me-3" title="TikTok"><i
                                    class="fab fa-tiktok"></i></a>
                            <a href="https://www.instagram.com/idspora.official/" class="text-light me-3"
