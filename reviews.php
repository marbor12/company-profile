...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .review-filters .nav-link:hover {
        transform: translateY(-2px);
        box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1);
      }

      .review-filters .nav-link.active {
        background: var(--primary-yellow);
        color: var(--dark-blue);
  ...
  <body>
    <div class="main-container">
      ...
      <section class="page-header">
        <div class="container">
          <h1 class="page-title" data-aos="fade-up">
            Ulasan tentang <span class="highlight-yellow">idSpora</span>
          </h1>
          <p class="page-subtitle" data-aos="fade-up" data-aos-delay="200">
            Temukan apa yang dikatakan peserta kami tentang pengalaman
            pembelajaran transformasional mereka dengan idSpora.
          </p>
        </div>
      </section>
      ...
      <section class="section-spacing-sm">
        <div class="container">
          ...
          <div class="text-center mt-5" data-aos="fade-up">
            <button class="btn btn-outline-dark btn-lg load-more-btn">
      ...
      <section
        ...
        style="background: var(--light-cream)"
      >
        <div class="container">
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        loadMoreBtn.addEventListener("click", function () {
          ...
          setTimeout(() => {
            this.innerHTML =
              '<i class="fas fa-check me-2"></i>Semua Ulasan Dimuat';
            this.disabled = true;
